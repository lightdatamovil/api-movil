export default class LogisticaConf {
    ...
    static hasObligatoryObservationsOnRegisterVisit = [4, 164];
    ...
    static hasObligatoryObservationsOnRegisterVisitEnabled(did) {
        return this.hasObligatoryObservationsOnRegisterVisit.includes(did * 1);
    }
